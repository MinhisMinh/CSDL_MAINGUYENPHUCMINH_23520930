...
SET DATEFORMAT DMY;
GO
--BT1: NHAP DU LIEU CHO QUANLYBANHANG--
----CHEN BANG KHACH HANG----
...
-- BT3: PHAN II --
-- 2.	Tao quanhe SANPHAM1 chua toan bo du lieu quan he SANPHAM. Tao quan he KHACHHANG1 chua toan bo du lieu quan he KHACHHANG
...
--BT5: PHAN III: TRUY VAN DU LIEU QUANLYBANHANG 
...
ALTER TABLE HOCVIEN ADD CONSTRAINT CHK_TUOI CHECK(GETDATE() - NGSINH >= 18)
GO

-- 12.	Giảng dạy một môn học ngày bắt đầu (TUNGAY) phải nhỏ hơn ngày kết thúc (DENNGAY).
ALTER TABLE GIANGDAY ADD CONSTRAINT CHK_NGAY CHECK(TUNGAY < DENNGAY)
GO

-- 13.	Giáo viên khi vào làm ít nhất là 22 tuổi.
ALTER TABLE GIAOVIEN ADD CONSTRAINT CHK_NGVL CHECK(GETDATE() - NGVL >= 22)
GO
...
HAVING COUNT(*) = SUM(CASE WHEN KQUA = 'Khong Dat' THEN 1 ELSE 0 END);
GO
